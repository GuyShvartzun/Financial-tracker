...
export default function MetricCards({ netWorth, liquid, nonLiquid, liabilities, growthPct }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      <div className="bg-[#FFFFFF] border border-[#C8E6C9] p-5 rounded-2xl shadow-xs relative overflow-hidden">
        <div className="text-xs text-stone-500 font-bold mb-1">סך הון כולל נטו</div>
        <div className="text-3xl font-black text-[#2E7D32] tracking-tight">{fmtILS(netWorth)}</div>
      ...
      <div className="bg-[#FFFFFF] border border-[#BBDEFB] p-5 rounded-2xl shadow-xs">
        ...
        <div className="text-3xl font-black text-[#1976D2] tracking-tight">{fmtILS(liquid)}</div>
      ...
      <div className="bg-[#FFFFFF] border border-[#E1BEE7] p-5 rounded-2xl shadow-xs">
        ...
        <div className="text-3xl font-black text-[#7B1FA2] tracking-tight">{fmtILS(nonLiquid)}</div>
      ...
      <div className="bg-[#FFFFFF] border border-[#FFCDD2] p-5 rounded-2xl shadow-xs">
        ...
        <div className="text-3xl font-black text-[#C62828] tracking-tight">₪{fmtNum(liabilities)}</div>
